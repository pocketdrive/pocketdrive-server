...
export const syncMetadataDb = new DataStore({filename: process.env.NE_DB_PATH_SYNC_METADATA, autoload: true});
...
export const nisMetadataDb = new DataStore({filename: process.env.NE_DB_PATH_NIS_METADATA, autoload: true});

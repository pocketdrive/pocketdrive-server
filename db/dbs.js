...
export const syncMetaDb = new DataStore({filename: process.env.NE_DB_PATH_FILE_METADATA, autoload: true});
...
// export const nisMetaDb = new DataStore({filename: process.env.NE_DB_PATH_NIS, autoload: true});
